...
const isObjectStrict = obj => ({}.toString.call(obj) == "[object Object]");

function buildObject(prop, idx, arr, obj, tempObj) {
  if (Array.isArray(arr[idx]) && (typeof arr[idx - 1] === "string" || idx === 0)) {
    tempObj[prop[0]] = {};
    ...
    if (Array.isArray(prop[1])) {
      ...
      return buildObject(prop[idx + 1], 1, arr, obj[prop[0]], tempObj[prop[0]]);
    }
