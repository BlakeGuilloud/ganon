...
describe("deepCompare", () => {
  test("objects are equal", () => {
    expect(deepCompare({a: "a", b: { c: { d: "d"}, e: "e"}}, {a: "a", b: { c: { d: "d"}, e: "e"}})).toBe(true);
    expect(deepCompare({a: 0, b: { c: { d: 1.8}, e: 2.9}}, {a: 0, b: { c: { d: 1.8}, e: 2.9}})).toBe(true);
    expect(deepCompare({a: [0], b: { c: { d: [{o: "o"}]}, e: [1,9,"test"]}}, {a: [0], b: { c: { d: [{o: "o"}]}, e: [1,9,"test"]}})).toBe(true);
  });

  test("objects are not equal", () => {
    expect(deepCompare({a: "a", b: { c: { d: "d"}, e: "e"}}, {a: "a", b: { c: { d: "d"}, e: "z"}})).toBe(false);
    expect(deepCompare({a: 0, b: { c: { d: 1.8}, e: 2.9}}, {a: 0, b: { c: { d: "1.8"}, e: 2.9}})).toBe(false);
    expect(deepCompare({a: [0], b: { c: { d: [{o: "o"}]}, e: [1,9,"test"]}}, {a: [0], b: { c: { d: ["o"]}, e: ["test",9,1]}})).toBe(false);
  });
