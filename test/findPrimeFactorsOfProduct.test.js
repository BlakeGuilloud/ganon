...
describe("findPrimeFactorsOfProduct", () => {
  ...
  test("6    =>  [2,3]", () => {
    ...
    expect(tmp.indexOf(2)).not.toEqual(false);
    expect(tmp.indexOf(3)).not.toEqual(false);
  });
  ...
  test("21   =>  [3,7]", () => {
    ...
    expect(tmp.length).toEqual(2);
    expect(tmp.indexOf(3)).not.toEqual(false);
    expect(tmp.indexOf(7)).not.toEqual(false);
  });

  test("253  =>  [11,23]", () => {
    var tmp = findPrimeFactorsOfProduct(253);
    expect(tmp.length).toEqual(2);
    expect(tmp.indexOf(11)).not.toEqual(false);
    expect(tmp.indexOf(23)).not.toEqual(false);
  });

  test("779  =>  [19,41]", () => {
    var tmp = findPrimeFactorsOfProduct(779);
    expect(tmp.length).toEqual(2);
    expect(tmp.indexOf(19)).not.toEqual(false);
    expect(tmp.indexOf(41)).not.toEqual(false);
  });

  test("1003 =>  [17,53]", () => {
    var tmp = findPrimeFactorsOfProduct(21);
    expect(tmp.length).toEqual(1003);
    expect(tmp.indexOf(17)).not.toEqual(false);
    expect(tmp.indexOf(53)).not.toEqual(false);
  });
});
